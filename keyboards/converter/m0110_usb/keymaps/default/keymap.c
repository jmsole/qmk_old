...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[0] = LAYOUT_ansi(
	       CTL_T(KC_GRV),    KC_1, KC_2, KC_3, KC_4, KC_5,   KC_6, KC_7,    KC_8,   KC_9,   KC_0,    KC_MINS, KC_EQL,  KC_BSPC,           KC_NLCK, KC_EQL, KC_PSLS, KC_PAST, \
	       ...
	       KC_RALT, KC_LGUI,                   KC_SPC,                      MO(1),  KC_BSLASH      , KC_LEFT, KC_RGHT, KC_DOWN,           KC_P0,           KC_PDOT),
	...
	[1] = LAYOUT_ansi(
		   ...
		   KC_CAPS, KC_HOME, KC_UP,   KC_PGUP, RESET, KC_NO, KC_NO, KC_NO, KC_PSCR, KC_SLCK, KC_PAUS, KC_UP,   KC_INS,           KC_P7,   KC_P8,  KC_P9,   KC_PMNS, \
	       ...
	       KC_LALT, KC_LGUI,                          KC_SPC,                       KC_TRNS, KC_NO  , KC_HOME, KC_END, KC_PGDN,  KC_P0,           KC_PDOT),
