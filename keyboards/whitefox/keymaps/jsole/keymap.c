...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MAC] = KEYMAP_TRUEFOX( \
        ...
        LT(_FLM, KC_BSPC),KC_A,  KC_S,  KC_D,  KC_F,  KC_G,  KC_H,  KC_J,  KC_K,  KC_L,  KC_SCLN,  KC_QUOT,       KC_ENT, KC_HOME,\
        KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH, KC_RSFT,    KC_UP,    KC_END,\
        KC_LCTL,KC_LALT,KC_LGUI,               KC_SPC,           KC_RALT,MO(_FLM),                         KC_LEFT,KC_DOWN,KC_RGHT\
    ),
    ...
    [_WIN] = KEYMAP_TRUEFOX( \
        ...
        KC_TAB, KC_Q,  KC_W,  KC_E,  KC_R,  KC_T,  KC_Y,  KC_U,  KC_I,  KC_O,  KC_P,   KC_LBRC,   KC_RBRC,      KC_BSPC,  KC_DEL,\
        LT(_FLW, KC_CAPS),KC_A,  KC_S,  KC_D,  KC_F,  KC_G,  KC_H,  KC_J,  KC_K,  KC_L,  KC_SCLN,  KC_QUOT,       KC_ENT, KC_HOME,\
        KC_LSFT,   KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH, KC_RSFT,    KC_UP,    KC_END,\
        KC_LCTL,KC_LGUI,KC_LALT,               KC_SPC,           KC_RALT,MO(_FLW),                         KC_LEFT,KC_DOWN,KC_RGHT\
    ),
        /* Layer 2: Function Mac Layer
     * ,---------------------------------------------------------------.
    ...
    [_FLM] = KEYMAP_TRUEFOX( \
        ...
        _______  ,_______,_______,_______,_______,_______,_______,_______, BL_DEC , BL_INC,BL_TOGG,KC__VOLDOWN,KC_MPLY,KC__VOLUP,\
        _______,_______,_______,               _______,          _______,_______,                        KC_MRWD,KC__MUTE,KC_MFFD\
    ),
        /* Layer 3: Function Win Layer
     * ,---------------------------------------------------------------.
     * |   | F1|F2 |F3 |F4 |F5 |F6 |F7 |F8 |F9 |F10|F11|F12|   |   |Ins|
     * |---------------------------------------------------------------|
     * |     |   |Up |   |   |   |   |   |   |   |Psc|   |   |     |   |
    ...
    [_FLW] = KEYMAP_TRUEFOX( \
        ...
        _______,_______,_______,               _______,          _______,_______,                        KC_MPRV,KC_MUTE, KC_MNXT\
    ),
        /* Layer 4: Super Layer
     * ,---------------------------------------------------------------.
     * |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |   |
